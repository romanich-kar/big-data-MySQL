...
INSERT INTO `profiles` (`user_id`, `gender`, `birthday`, `city`, `country`, `created_at`, `updated_at`) VALUES (10, 'F', '2013-01-21', 'Isabellemouth', 'Hong Kong', '1992-05-10 19:04:19', '2014-08-28 10:34:19');
...
INSERT INTO `messages` (`id`, `from_user_id`, `to_user_id`, `body`, `is_important`, `is_delivered`, `created_at`, `media_id`) VALUES (4, 4, 4, 'Minus molestiae ipsum eos recusandae voluptatem ex animi. Aut ratione illo quis quibusdam ut quos. Rerum repellat voluptate eius dolorem optio nostrum.', 0, 1, '2005-05-03 18:33:58', 5);
INSERT INTO `messages` (`id`, `from_user_id`, `to_user_id`, `body`, `is_important`, `is_delivered`, `created_at`, `media_id`) VALUES (5, 5, 5, 'Vero dolores iure sint vitae ipsa a nulla. Harum sit aut et dolorem doloribus. Occaecati magnam officiis impedit ipsa nam autem aut.', 1, 0, '1979-01-29 04:03:08', NULL);
...
INSERT INTO `messages` (`id`, `from_user_id`, `to_user_id`, `body`, `is_important`, `is_delivered`, `created_at`, `media_id`) VALUES (7, 7, 7, 'Tempora velit odit quasi deserunt minima. Aut autem et quibusdam fugit optio. At necessitatibus hic consequatur eos aliquam soluta sint.', 0, 1, '1975-04-26 22:08:10', NULL);
INSERT INTO `messages` (`id`, `from_user_id`, `to_user_id`, `body`, `is_important`, `is_delivered`, `created_at`, `media_id`) VALUES (8, 8, 8, 'Est nesciunt repellendus delectus dignissimos autem exercitationem est. Aut et ipsum aliquid ut et ipsum suscipit distinctio. Ab et enim accusantium asperiores est sit.', 1, 0, '2019-02-19 06:04:34', 7);
...
ALTER TABLE users_likes ADD CONSTRAINT fk_users_likes_users FOREIGN KEY (user_id) REFERENCES users (id);
ALTER TABLE users_likes ADD CONSTRAINT fk_users_likes_users_2 FOREIGN KEY (user_2_id) REFERENCES users (id);
...
CREATE TABLE `posts` (
  ...
  media_id int(10) unsigned COMMENT 'Ссылка на возможный медиа файл в сообщении',
